...
module.exports = function (app, options) {
  ...
  // 合并传入的对象
  options.resources && assign(resources, options.resources);
   ...
   * 更新多语言配置
   */
  app.updatei18Resources = function updatei18Resources(newResources) {
    return assign(resources, newResources);
  }
  ...
  app.context.__getLocale = function () {
    ...
    // 1. path
    let locale = options.getLocaleFromPath(this);
    let localeOrigin = 'path';
